...
public class BluetoothGameService {
    ...
    public synchronized void connect(BluetoothDevice device) {
        ...
        // Cancel any thread attempting to make a connection
        System.out.println("device inside connect method: "+device);
        if (mState == STATE_CONNECTING) {
        	System.out.println(" inside connect method: mState: "+mState);
            if (mConnectThread != null) {mConnectThread.cancel(); mConnectThread = null;}
        }
        System.out.println(" inside connect method: mConnectedThread: "+mConnectedThread);
        // Cancel any thread currently running a connection
        if (mConnectedThread != null) {mConnectedThread.cancel(); mConnectedThread = null;}
